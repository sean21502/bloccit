...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  describe "POST #create" do
    it "increases the number of advertisements by 1" do
      expect{post :create, params: {advertisement: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 100}}}.to change(Advertisement,:count).by(1)
    end
